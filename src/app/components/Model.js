...
export function Model({ instances, ...props }) {
  ...
  return (
    <>
      <Select enabled={hovered === 'engine'} onPointerOver={over('engine')} onPointerOut={() => debouncedHover(null)}>
      ...
      <Text position={[0, 1, 0]} color="white" fontSize={0.15} font="Inter-Regular.woff" letterSpacing={-0.05}>
        {hovered ? hovered : ''}
      </Text>
    </>
  )
